...
<%@ taglib prefix="c" uri="http://java.sun.com/jstl/core_rt"%>
			         ...
			         <span class="formFieldError" id="errorSpan" style="display: none;"></span>
                        <form:form method="POST" commandName="reasonToDeleteForm" action="deleteDropPost.htm" cssClass="dialog-form" id="deleteDropPostForm">
                           ...
                           <a class="btn btn-primary" onclick="submitForm('deleteDropPostForm')" href="#">Delete</a>
                        </form:form>
                    </div>
