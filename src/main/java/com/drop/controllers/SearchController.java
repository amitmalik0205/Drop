	...
	public ModelAndView getMatchingDeals(
		...
		try {			
			...
			if(searchType.equals("Drops")) {
				dealPostListForSearch = solrSearchService.searchDrops(searchStr, 0, SORT_TYPE.PRICE, null);
				map.addAttribute("dealPostListForSearch",dealPostListForSearch);
			} else {
				dealWantedListForSearch = solrSearchService.searchWanted(searchStr, 0, SORT_TYPE.PRICE, null);
			...
			searchDealForm.setMaxItemsOnpage(18);
